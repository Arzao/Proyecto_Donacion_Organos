...
* `/reportes/`: Contiene los documentos PDF que resumen las fases del proyecto.
    ...
    * `03_Analisis_Hallazgos.pdf`: Es el reporte final del proyecto que incluye el proceso de introducción y planificación, limpieza y transformación y la adición de las **gráficas y conclusiones** del análisis.
- - -
...
- - -
* `dashboard.py`: Aplicación interactiva desarrollada con **Streamlit** que presenta visualizaciones dinámicas del análisis de donación de órganos. Incluye gráficos interactivos, filtros por región y métricas clave del dataset. Se ejecuta con el comando `streamlit run dashboard.py`.
